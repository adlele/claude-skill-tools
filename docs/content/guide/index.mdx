...
|:-----|:--------|:------------|
| [Composer](composer) | Orchestrate end-to-end workflows | `composer compose full --ado 12345` |
| [Sandbox](sandbox) | Manage worktree sandboxes and run ralph loops | `sandbox start --role architect --context "..."` |
| [Session Explorer](session-explorer) | Analyze Claude session logs | `session-explorer <sessionId>` |
